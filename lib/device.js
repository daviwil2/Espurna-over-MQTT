  ...
  _setCapabilityLightSaturation(value, opts, callback){
    ...
    return new Promise(function(resolve, reject){
      ...
      if (advancedSettings.hasOwnProperty('controls') == -1 || advancedSettings.controls !== 'RGB'){
        return reject(new Error('malformed advancedSettings object in _setCapabilityLightHue'))
      }; // if
  ...
  _setCapabilityDim(value, opts){
    ...
    return new Promise(function(resolve, reject){
      ...
      if (advancedSettings.hasOwnProperty('controls') === -1 || !advancedSettings.controls){
        return reject(new Error('malformed advancedSettings object in _setCapabilityLightDim'))
      }; // if
