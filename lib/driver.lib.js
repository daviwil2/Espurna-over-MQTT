...
module.exports = exports = function(){
  ...
  // populate the serverSettings object from ManagerSettings; this contains the custom settings for this device
  ...
  // add event handler that is fired when server settings change
